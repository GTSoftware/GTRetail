...
package ar.com.gtsoftware.controller.ventas.dto;
...
public class ComprobanteRelacionado {
    ...
    private List<ComprobantesLineasDto> comprobantesLineas;
    private NegocioTiposComprobanteEnum tipoComprobante;
}
