...
import ar.com.gtsoftware.bl.LegalGenerosService;
import ar.com.gtsoftware.dto.model.LegalGenerosDto;
...
public class LegalGenerosServiceImpl
        extends AbstractBasicEntityService<LegalGenerosDto, GenerosSearchFilter, LegalGeneros>
        implements LegalGenerosService {

    @EJB
    private LegalGenerosFacade facade;

    @Inject
    private LegalGenerosMapper mapper;
