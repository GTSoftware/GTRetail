...
public class ProductoXDepositoServiceImpl
        extends AbstractBasicEntityService<ProductoXDepositoDto, ProductoXDepositoSearchFilter, ProductoXDeposito>
        implements ProductoXDepositoService {


    @EJB
    private ProductoXDepositoFacade facade;

    @Inject
    private ProductoXDepositoMapper mapper;
