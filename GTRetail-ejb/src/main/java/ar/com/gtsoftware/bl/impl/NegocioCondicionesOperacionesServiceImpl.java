...
import ar.com.gtsoftware.bl.NegocioCondicionesOperacionesService;
import ar.com.gtsoftware.dto.model.NegocioCondicionesOperacionesDto;
...
public class NegocioCondicionesOperacionesServiceImpl
        extends AbstractBasicEntityService<NegocioCondicionesOperacionesDto, AbstractSearchFilter, NegocioCondicionesOperaciones>
        implements NegocioCondicionesOperacionesService {


    @EJB
    private NegocioCondicionesOperacionesFacade facade;

    @Inject
    private NegocioCondicionesOperacionesMapper mapper;
