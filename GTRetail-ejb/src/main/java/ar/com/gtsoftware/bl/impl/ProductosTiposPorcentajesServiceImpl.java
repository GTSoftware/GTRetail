...
import ar.com.gtsoftware.bl.ProductosTiposPorcentajesService;
import ar.com.gtsoftware.dto.model.ProductosTiposPorcentajesDto;
...
public class ProductosTiposPorcentajesServiceImpl
        extends AbstractBasicEntityService<ProductosTiposPorcentajesDto, AbstractSearchFilter, ProductosTiposPorcentajes>
        implements ProductosTiposPorcentajesService {

    @EJB
    private ProductosTiposPorcentajesFacade facade;

    @Inject
    private ProductosTiposPorcentajesMapper mapper;
