...
public class RemitoTipoMovimientoServiceImpl
        extends AbstractBasicEntityService<RemitoTipoMovimientoDto, AbstractSearchFilter, RemitoTipoMovimiento>
        implements RemitoTipoMovimientoService {

    @EJB
    private RemitoTipoMovimientoFacade facade;

    @Inject
    private RemitoTipoMovimientoMapper mapper;
