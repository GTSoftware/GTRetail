...
import ar.com.gtsoftware.bl.BancosService;
import ar.com.gtsoftware.dto.model.BancosDto;
...
public class BancosServiceImpl
        extends AbstractBasicEntityService<BancosDto, BancosSearchFilter, Bancos>
        implements BancosService {

    @EJB
    private BancosFacade facade;
    @Inject
