 ...
 */
@Stateless
public class LegalTiposPersoneriaFacade extends AbstractFacade<LegalTiposPersoneria> {
    ...
    public LegalTiposPersoneriaFacade() {
    ...
    @Override
    public void createOrEdit(LegalTiposPersoneria entity) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
