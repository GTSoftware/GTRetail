 ...
 */
@Stateless
public class LegalTiposDocumentoFacade extends AbstractFacade<LegalTiposDocumento> {
    ...
    public LegalTiposDocumentoFacade() {
    ...
    @Override
    public List<LegalTiposDocumento> findAllBySearchFilter(AbstractSearchFilter sf) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    @Override
    public void createOrEdit(LegalTiposDocumento entity) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
